...
class Module extends CI_Controller {
		...
		$this->url = base_url('/admin/module');
		$this->load->model('auth_model');
    }
    //variables
    private $single= 'Module';
    private $multi= 'Modules';
    private $add= 'addmod';
    private $all= 'allmod';
    private $url= '';
    private $modal= '';
	...
	public function save($id = 0)
	{
        ...
        $this->form_validation->set_rules('credits', $this->single.' Credits', 'required');
	...
	public function create($id= 0)
	{
		...
		$this->modal->table = 'courses';
		$this->modal->key = 'id';
		$data['courses']= $this->modal->get(array('status'=> 0));
		$this->modal->table = 'module';
