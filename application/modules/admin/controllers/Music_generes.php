...
class Music_generes extends CI_Controller {
		...
		$this->Common_model->table = 'music_generes';
		$this->modal = $this->Common_model;
		$this->url = base_url('/admin/music_generes');
		$this->load->model('auth_model');
    }
    //variables
    private $single= 'MusicGenere';
    private $multi= 'Music Generes';
