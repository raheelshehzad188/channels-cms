...
header('Access-Control-Allow-Origin: *');
	...
	public function save()
	{
        ...
        else
        {
        	...
        	{
                $this->session->set_flashdata('success', 'Gateway add successfully!');
        	}
        	else
        	{
	...
	public function create()
	{
		...
		$this->template->admin('addtag',$data);
	}
	public function all()
	{
		$data= array();
		$data['assets']= base_url('assets/admin/');
		$data['data']= $this->Tags_model->get(array('status'=> 0));
		$this->template->admin('alltags',$data);
	}
