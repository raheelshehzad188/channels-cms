                        ...
                        <table class="table data-list-view">
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    {
                                        ?>
                                        <td><i class="fa fa-circle font-small-3 text-success mr-50"></i>Assigned</td>
                                        <?php
                                    }
                                    else
                                    {
                                        ?>
                                        <td><i class="fa fa-circle font-small-3  mr-50"></i>Unassigned</td>
                                        <?php
                                    }
                                    ?>
                                    ...
                                    <td class="product-action">
                                        ...
                                        <?php
                                        if(isset($is_send) && !$value['user'])
                                        {
                                        ?>
                                        <a onclick="sendSingle(<?= $value['id'] ?>)">
