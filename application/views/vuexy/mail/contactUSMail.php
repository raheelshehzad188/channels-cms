                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse;">
                    <tr>
                        <td align="center" bgcolor="#046fbf" style="padding: 40px 0 30px 0;background: #ea0a60; color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;">
                            <a href="#">
                                <img src="<?= base_url() ?>/assets/books/images/logo.png" alt="SHAREBOOK" width="170" height="118" style="display: block;" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                  <p> please contact with <?= $name ?> email <strong><?= $email ?></strong></p>   
                                </tr>
                            </table>
                        </td>
                    </tr>
