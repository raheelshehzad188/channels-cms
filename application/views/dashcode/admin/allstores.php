                    ...
                    <div class="relative">
                      <div class="dropdown relative">
                        ...
                        <ul class="dropdown-menu min-w-[120px] absolute text-sm text-slate-700 dark:text-white hidden bg-white dark:bg-slate-700 shadow z-[2] float-left overflow-hidden list-none text-left rounded-lg mt-1 m-0 bg-clip-padding border-none">
                          <li>
                            <a href="<?= $url . '/create/' . $store['id']; ?>" class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white">
                              Edit
                            </a>
                          </li>
                          <li>
                            <a href="<?= $url . '/delete/' . $store['id']; ?>" class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white" onclick="return confirm('Delete this store?');">
                              Delete
                            </a>
                          </li>
                        </ul>
