...
<head>
  ...
  <!-- BEGIN: Theme CSS-->
  <link rel="stylesheet" href="<?= $assets; ?>assets/css/rt-plugins.css">
  <link rel="stylesheet" href="<?= $assets; ?>assets/css/app.css">
  <!-- End : Theme CSS-->
  <script src="<?= $assets; ?>assets/js/settings.js" sync></script>
</head>
  ...
  <main class="app-wrapper">
    ...
    <div class="sidebar-wrapper group">
      ...
      <div class="logo-segment">
        <a class="flex items-center" href="<?= base_url('admin/admin'); ?>">
          <?php $logo = config_item('app_logo'); ?>
          <img src="<?= $logo; ?>" class="black_logo max-h-10" alt="logo">
          <span class="ltr:ml-3 rtl:mr-3 text-xl font-Inter font-bold text-slate-900 dark:text-white"><?= config_item('app_name'); ?></span>
        </a>
        <!-- Sidebar Type Button -->
    ...
    <div class="flex flex-col justify-between min-h-screen">
      <div>
          ...
          <div class="app-header z-[999] ltr:ml-[248px] rtl:mr-[248px] bg-white dark:bg-slate-800 shadow-sm dark:shadow-slate-700">
            <div class="flex justify-between items-center h-full">
              <div class="flex items-center md:space-x-4 space-x-2 xl:space-x-0 rtl:space-x-reverse vertical-box">
                <a href="<?= base_url('admin/admin'); ?>" class="mobile-logo xl:hidden inline-block">
                  <img src="<?= $assets; ?>assets/images/logo/logo-c.svg" class="black_logo" alt="logo">
                  <img src="<?= $assets; ?>assets/images/logo/logo-c-white.svg" class="white_logo" alt="logo">
                </a>
        ...
        <img src="<?= $assets; ?>assets/images/logo/logo.svg" class="black_logo " alt="logo">
        <img src="<?= $assets; ?>assets/images/logo/logo-white.svg" class="white_logo" alt="logo">
    </span>
        ...
        <img src="<?= $assets; ?>assets/images/logo/logo-c-white.svg" class="white_logo " alt="logo">
              ...
              <div class="main-menu">
                <ul>
                  ...
                  <li>
                    <a href="<?= base_url('admin/stores/all'); ?>">
                      <div class="flex flex-1 items-center space-x-[6px] rtl:space-x-reverse">
                        <span class="icon-box">
                          <iconify-icon icon="heroicons-outline:building-storefront"></iconify-icon>
                        </span>
                        <div class="text-box">Stores</div>
                      </div>
                    </a>
                  </li>
                  <li>
                    <a href="<?= base_url('admin/user/all'); ?>">
                      <div class="flex flex-1 items-center space-x-[6px] rtl:space-x-reverse">
                        <span class="icon-box">
                  ...
                  <li>
                    <a href="<?= base_url('admin/worthiest/all'); ?>">
                      <div class="flex flex-1 items-center space-x-[6px] rtl:space-x-reverse">
                        <span class="icon-box">
                          <iconify-icon icon="heroicons-outline:star"></iconify-icon>
                        </span>
                        <div class="text-box">Worthiests</div>
                      </div>
                    </a>
                  </li>
                  <li>
                    <a href="<?= base_url('admin/order/all'); ?>">
                      <div class="flex flex-1 items-center space-x-[6px] rtl:space-x-reverse">
                        <span class="icon-box">
                          <iconify-icon icon="heroicons-outline:shopping-cart"></iconify-icon>
                        </span>
                        <div class="text-box">Orders</div>
                      </div>
                    </a>
                  </li>
                  <li>
                    <a href="<?= base_url('admin/organization/all'); ?>">
                      <div class="flex flex-1 items-center space-x-[6px] rtl:space-x-reverse">
                        <span class="icon-box">
                          <iconify-icon icon="heroicons-outline:office-building"></iconify-icon>
                        </span>
                        <div class="text-box">Organizations</div>
                      </div>
                    </a>
                  </li>
                </ul>
      ...
      inline-flex items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="lg:h-8 lg:w-8 h-7 w-7 rounded-full flex-1 ltr:mr-[10px] rtl:ml-[10px]">
                      <img src="<?= $assets; ?>assets/images/all-img/user.png" alt="user" class="block w-full h-full object-cover rounded-full">
                    </div>
                    <span class="flex-none text-slate-600 dark:text-white text-sm font-normal items-center lg:flex hidden overflow-hidden text-ellipsis whitespace-nowrap"><?= isset($_SESSION['knet_login']) ? $_SESSION['knet_login']->first_name . ' ' . $_SESSION['knet_login']->last_name : ''; ?></span>
      ...
      overflow-hidden">
                    <ul class="py-1 text-sm text-slate-800 dark:text-slate-200">
                      <li>
                        <a href="<?= base_url('admin/admin'); ?>" class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600 dark:text-white font-normal">
                      ...
                      <li>
                        <a href="<?= base_url('admin/admin/chpass'); ?>" class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600 dark:text-white font-normal">
                      ...
                      <li>
                        <a href="<?= base_url('admin/admin/logout'); ?>" class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600 dark:text-white font-normal">
